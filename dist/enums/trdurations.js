...
exports.getDurationByType = exports.trDurations = void 0;
exports.trDurations = [
    ...
    { id: 5, trt: 2, days: 5, title: null, type: 'type' },
    { id: 6, trt: 3, days: 5, title: null, type: 'type' },
    { id: 7, trt: 4, days: 5, title: null, type: 'type' },
...
exports.getDurationByType = (id) => {
    const duration = exports.trDurations.filter(itm => itm.trt === id);
    return duration;
};
